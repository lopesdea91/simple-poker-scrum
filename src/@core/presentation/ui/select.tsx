...
const SelectRoot: React.FC<SelectRootProps> = ({ children, className, onValueChange, defaultValue, value, disabled, ...props }) => {
  return (
    <div {...props} className={cn('p-1 flex flex-col gap-1', className)}>
      <SelectPrimitive.Root {...{ onValueChange, defaultValue, value, disabled }}>
        {children}
